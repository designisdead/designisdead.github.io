...
<template>
  <main>
    <article>
      <header class="Job-header Wrapper halfscreen u-textAlignCenter u-backgroundColor--black u-color--light">
        <wrapper size="large">
          <h1>{{ pagetitle }}</h1>
      ...
      <div class="Job-form-container">
        <form method="POST" action="https://designisdead.activehosted.com/proc.php" id="" class="Job-form _inline-form _inline-style _dark" novalidate>
          ...
          <div class="_form-content">
            ...
            <div class="_form_element _x22102590 _inline-style _clear" >
              <div class="_html-code">
                <p>
                  Hello Design is Dead I'm...
                </p>
              </div>
            </div>
            <div class="_form_element _x04713497 _inline-style " >
            ...
            <div class="_form_element _x03259613 _inline-style " >
              <label class="_form-label">
                Email*
              </label>
              <div class="_field-wrapper">
            ...
            <div class="_form_element _field11 _inline-style " >
              <input type="hidden" name="field[11]" value="Java / AEM Developer" />
            </div>
...
<style lang="scss">
 ...
 .Job-form {
    ...
    * {
    ...
    @media all and (min-width:320px) and (max-width:667px) {
      ._inline-style ._inline-style._button-wrapper {
